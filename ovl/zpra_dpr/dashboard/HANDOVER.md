...
| Fiori Overview Page app `zdprdashboard` | BAS dev space, project `zdprdashboard`; the files that differ from the generator output are in `webapp/` here | six cards render in BAS preview; NOT deployed to Cloud Foundry / Work Zone yet |
