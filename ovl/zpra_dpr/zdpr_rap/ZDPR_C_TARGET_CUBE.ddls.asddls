...

{
  ...
  // Unit binding removed from the three quantity measures: the SmartChart of
  // the Analytical List Page refuses to draw a measure whose unit differs
  // across the result (BOPD for oil, MMSCMD for gas). ActualUom / TargetUom
  // stay as plain columns next to the figures in the table.
