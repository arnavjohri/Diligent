...

{
  ...
  /* Unit-free BOE measures from the cube, so the detail app can chart Oil and
     Gas on one axis (the UoM-bound measures above refuse mixed units). */
  @AnalyticsDetails.query.axis: #COLUMNS
  @EndUserText.label: 'JV Production (BOE)'
  BoepdQty,
