...
| `zfi_tds_cl34_scr.prog.abap` | 164 | The five selection fields (S_SECTN filters column H, not BSEG-SECCO), plus the manual-steps checklist as a trailer comment. |
| `zfi_tds_cl34_forms.prog.abap` | 2397 | Every form routine. |
