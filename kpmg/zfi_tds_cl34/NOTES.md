...
vendor: one row per withholding-tax item, 25 FS columns plus a Debit/Credit indicator
added 07/09/26 (col Z), GL wise and document number wise.
...
| `zfi_tds_cl34_top.prog.abap` | 684 | `TABLES`, `TYPES`, `CONSTANTS`, global `DATA`. No executable statement. |
...
| `zfi_tds_cl34_forms.prog.abap` | 2455 | Every form routine. |
