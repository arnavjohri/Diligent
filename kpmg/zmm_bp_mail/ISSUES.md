...
| 25/09/26 | Column-width fix activated and verified: full headings "Business Partner", "Supplier Manager Email", "Supplier Contact Email" shown; 14 BPs, 3 recipients | — | Code stable. Remaining: SCOT node (Basis), delivered-mail subject/body check, functional sign-off on the two logged behaviours (no LFA1 → excluded; no 004/005 → included, no recipient), SE93 / variant / SM36 | `<TR>` |
